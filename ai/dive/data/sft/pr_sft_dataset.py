...
class SFTDataModule():
    def __init__(self, tokenizer, data_path: str, num_samples=-1, max_seq_len=-1):
        self.dataset = PRSFTDataset(data_path=data_path, tokenizer=tokenizer, num_samples=num_samples, max_seq_len=max_seq_len)
